...
const LoginPopup = ({ onClose, onSignUpClick, onForgotPasswordClick, onLogin }) => {
  ...
  // Handle dummy login tanpa axios
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Login successful!');
    onLogin(); // Simulasi login berhasil
    onClose(); // Tutup modal login setelah berhasil login
  };
          ...
          <div className="w-full max-w-[400px] mt-4 sm:mt-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input type="text" className="border border-gray-300 rounded-lg w-full py-2 px-3" value={username} onChange={(e) => setUsername(e.target.value)} required />
              </div>
              <div>
            ...
            <div className="flex justify-center">
              <button className="bg-white border rounded-lg py-2 px-4 flex items-center text-gray-700 hover:bg-gray-100">
